  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.btnrw1}>
          <Text style={styles.reguser}>Recent Daily Updates</Text>
        ...
        <View style={styles.b1}>
          ...
          <Text></Text>
          <Text></Text>
          <Text style={styles.reguser2}>No Daily updates</Text>
          <Text></Text>
...
function DailyUpdatesScreen({ navigation }) {
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      <DailyUpdates/>
    </View>
...
export default function Userhome1() {
    ...
    return (
      ...
      <Drawer.Navigator initialRouteName="Home">
        ...
        <Drawer.Screen name="My Inquiries" component={MyInquiryScreen} />
        <Drawer.Screen name="Notification" component={NotificationsScreen} />
        <Drawer.Screen name="DailyUpdates" component={DailyUpdatesScreen} />
